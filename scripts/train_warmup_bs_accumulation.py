...
def main(args):
    ...
    #     torch.load("pretrained_weights/DiT-XL-2-512x512.pt"), strict=False
    # )
    ...
    # ema.load_state_dict(torch.load('sky_grid_gen_ckpts_ft_dit/000-DiT-XL-2/checkpoints/0050000.pt')["ema"])
